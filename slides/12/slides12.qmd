...
`r flipbookr::chunk_reveal("gss-religion-tv", font_size_code="70%", title = "Which religions watch the least TV?")`
...
gss_cat %>%
  ...
  aes(y = relig) +                      #ROTATE
  aes(y = fct_reorder(relig, tvhours)) + #ROTATE
  geom_point()
```

`r flipbookr::chunk_reveal("reorder-tv-relig", break_type = "rotate", widths = c(1.2,1), title = "Reorder relig by tvhours")`
...
gss_cat %>%
  ...
  aes(color = marital) +                                     #ROTATE
  aes(color = fct_reorder2(marital, .x = age, .y = prop)) +  #ROTATE
  geom_line() +
  scale_color_colorblind("")
```

`r flipbookr::chunk_reveal("reorder-marital-age", title = "Reorder marital",  break_type = "rotate", widths = c(40, 60))`
...
`r flipbookr::chunk_reveal("other-reordering-functions", title = "Other reordering functions",  break_type = "rotate", widths = c(40, 60))`
...
`r flipbookr::chunk_reveal("fct-recode-partyid", title = "Recoding partyid",  widths = c(40, 60))`
...
`r flipbookr::chunk_reveal("fct-collapse-partyid", title = "Collapsing partyid",  widths = c(40, 60))`
...
`r flipbookr::chunk_reveal("fct-lump-partyid", title = "Lumping parytid",  break_type = "rotate", widths = c(40, 60))`
