...
```{r}
#| label: other-reordering-functions1
#| echo: true
#| eval: true
gss_cat %>%
  ggplot() + 
...
```{r}
#| label: other-reordering-functions2
#| echo: true
#| eval: true
gss_cat %>%
  ggplot() + 
...
```{r}
#| label: other-reordering-functions3
#| echo: true
#| eval: true
gss_cat %>%
  ggplot() + 
