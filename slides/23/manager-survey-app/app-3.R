      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          conditionalPanel(
            ...
            sliderInput(
              inputId = "___", # what is this value referred to later in the code?
              label = "Zoom in to salaries between",
              min = ____, # what is lowest possible value (pre-filtering) we should accept?
              value = _____, # what should the initial range be set to?
              max = _____, # what is highest possible value (pre-filtering) we should accept?
              width = "100%"
            )
          ),
