...
Sure, we have replaced the calculations with a function that will behave identically for all columns, but we are still repeating ourselves 10 times
...
Write a `for` loop that calculates the mean of the numeric variables in the `penguins` data set and stores the means in a named vector. Don't forget to create an object to store your results before you run the loop!
:::
