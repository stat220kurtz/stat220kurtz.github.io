---
title: "Data Wrangling <br> with `dplyr`"
subtitle: Day 07
...
Learning `dplyr` functions (verbs)

-   `filter()`
-   `slice()`, `slice_min()`, and `slice_max()`
-   `select()`
-   `arrange()`
-   `mutate()`
-   `case_when()`
...
##  {background-image="../img/horst_dplyr_mutate.png" background-size="62%"}

## Translating wind speed to km/hour

We can calculate km/hr by using: 
...
##  {background-image="../img/horst_dplyr_case_when.png" background-size="80%"}
