...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1VQ3bmJ2cQUn9wQOYuk7wBCe6xMPhsRtiQlzj7l-BKiM/edit?usp=sharing")
...
d |>
  ...
  rowwise() |>
  mutate(materials = ifelse(date <= today() + days(14), materials, "tbd")) |>
  gt() |>
  ...
  # Convert raw text references to hyperlinks
  fmt_markdown(
    columns = c(topic, prepare, materials, due)
  ) |>
  cols_width(
