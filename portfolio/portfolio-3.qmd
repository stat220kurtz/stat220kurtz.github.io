...
-   [ ] Create a function called `subject_category_count()` that: 
      - [ ] Takes in a user-specified character vector of subjects and the jeopardy dataset
      - [ ] Accurately counts the number of times each of those subjects shows up in `category`
      - [ ] Correctly works - this should be directly demonstrated in the write up by running a line of code that executes the function with this vector - c("history", "science") - which should return a count of 279 for history and 277 for science
