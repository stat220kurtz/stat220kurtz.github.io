...
Each of the two questions you come up with should involve at least two variables to answer. You should phrase them in a way that the is within the scope of inference of your data. For example, if you have an observational dataset, you shouldn’t phrase your question in a causal way. **Your questions shouldn't be identical to the example questions in the TidyTuesday repo pages.**
